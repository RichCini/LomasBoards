...
IDEBase		equ	030H		; base address of the board
					; In the Lomas setup, port 30h is available but will conflict
					; with testing in a PC emulation environment as this port is 
					; the AT 8259 master interrupt controller.
